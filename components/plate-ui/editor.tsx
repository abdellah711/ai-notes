...
const editorVariants = cva(
  cn(
    ...
    "placeholder:text-neutral-500/80 [&_[data-slate-placeholder]]:top-[auto_!important] [&_[data-slate-placeholder]]:text-neutral-500/80 [&_[data-slate-placeholder]]:!opacity-100 dark:placeholder:text-neutral-400/80 dark:[&_[data-slate-placeholder]]:text-neutral-400/80",
    "[&_strong]:font-bold"
  ),
  {
    defaultVariants: {
